...
const en: Translations = {
  ...
  markUnwatched: 'Remove watched mark',
  director: 'Director',
  cast: 'Cast',
  country: 'Country',
...
const ru: Translations = {
  ...
  markUnwatched: 'Снять отметку просмотра',
  director: 'Режиссёр',
  cast: 'В ролях',
  country: 'Страна',
...
const de: Translations = {
  ...
  markUnwatched: 'Gesehen-Markierung entfernen',
  director: 'Regisseur',
  cast: 'Besetzung',
  country: 'Land',
...
const uk: Translations = {
  ...
  markWatched: 'Позначити перегляд',
  markUnwatched: 'Зняти позначку перегляду',
  director: 'Режисер',
  cast: 'У ролях',
  country: 'Країна',
